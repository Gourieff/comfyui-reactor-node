...
- Нод ReActorImageDublicator - полезен тем, кто создает видео, помогает продублировать одиночное изображение в несколько копий, чтобы испльзовать их, к примеру, с VAE энкодером:
