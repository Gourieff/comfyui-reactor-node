...
class reactor:
    ...
    def execute(self, enabled, input_image, swap_model, detect_gender_source, detect_gender_input, source_faces_index, input_faces_index, console_log_level, face_restore_model, facedetection,n_thread, source_image=None, face_model=None):
