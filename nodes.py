...
from reactor_utils import batch_tensor_to_pil, batched_pil_to_tensor, tensor_to_pil
...
class reactor:
    ...
    def execute(self, source_image, input_image, swap_model, detect_gender_source, detect_gender_input, source_faces_index, input_faces_index, console_log_level):
        ...
        script.process(
            ...
            # restore_first=True,upscaler_name=None,
            # upscaler_scale=1,
